...
function appendHtml() {
   ...
   fetch('https://fast-savannah-12571.herokuapp.com/getdata').then(data => data.json()).then(data =>{
    ...
    for(var i=0;i<arrays.length;++i) {
        ...
        var cardHeading3 = document.createElement("h5")
        cardHeading3.classList.add("card-title")
        cardHeading.textContent = arrays[i].FirstName
        cardHeading2.textContent =" "+   arrays[i].LastName +", "
        cardHeading3.textContent =arrays[i].Age
        ...
        cardBody.appendChild(cardHeading3)
